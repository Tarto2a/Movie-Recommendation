...
if __name__ == "__main__":
    ...
    input_file = os.path.join("data", "raw", "MRS_Dataset_nlp.csv")  # Input file path
    output_file = os.path.join("data", "processed", "processed_MRS_Dataset_nlp.csv")  # Output file path
